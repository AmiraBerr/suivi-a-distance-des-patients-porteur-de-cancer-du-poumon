...
import Espace_praticien.oncologue;
 ...
 * @author pc
 */
public class CR_examination extends javax.swing.JFrame {

    /**
     * Creates new form CR_examination
     */
    public CR_examination() {
        initComponents();
        
         fonctions.DateSystem(date_saisie);
        id.setVisible(false);
        spece.setVisible(false);
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(901, 714));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void rSButtonHover1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonHover1ActionPerformed
         inter_RapportExamination RE = new inter_RapportExamination();
            String s1=date_saisie.getText();
            String s2= doss.getText();
            String s3=context.getText();
            String s4=spece.getText();
            String s5=id.getText();
            
            
            RapportExamination R;
            R = new RapportExamination(s1,s4,s3,s2, s5);
            RE.insertrapport_Examination(R);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CR_examination.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CR_examination().setVisible(true);
            }
        });
    }
