...
import interfaces.inter_Anatomie_Pathologique;
 ...
 * @author pc
 */
public class CR_pathologiste extends javax.swing.JFrame {

    /**
     * Creates new form CR_pathologiste
     */
    public CR_pathologiste() {
        initComponents();
    ...
    private void rSButtonHover1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonHover1ActionPerformed
        inter_Anatomie_Pathologique RE = new inter_Anatomie_Pathologique ();
        ...
        AnatomiePatologique  R;
        R = new  AnatomiePatologique(s1,s3,s2, s5);
        RE.insertAnatomiePathologique(R);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CR_pathologiste.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CR_pathologiste().setVisible(true);
            }
        });
    }
