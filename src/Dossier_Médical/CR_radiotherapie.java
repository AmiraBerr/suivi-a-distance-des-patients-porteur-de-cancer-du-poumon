...
import interfaces.inter_Radiotherapie;
 ...
 * @author pc
 */
public class CR_radiotherapie extends javax.swing.JFrame {

    /**
     * Creates new form CR_radiotherapie
     */
    public CR_radiotherapie() {
        initComponents();
    ...
    private void rSButtonHover1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonHover1ActionPerformed
        inter_Radiotherapie RE = new  inter_Radiotherapie();
        ...
        String s5=id.getText();
         ...
         Radiotherapie R;
        R = new Radiotherapie(s1,s3,s2, s5);
        RE. insert_radiotherapie(R);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CR_radiotherapie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CR_radiotherapie().setVisible(true);
            }
        });
    }
