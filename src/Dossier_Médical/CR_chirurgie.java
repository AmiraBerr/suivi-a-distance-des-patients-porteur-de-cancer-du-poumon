...
import interfaces.inter_Chirurgie;
 ...
 * @author pc
 */
public class CR_chirurgie extends javax.swing.JFrame {

    /**
     * Creates new form CR_chirurgie
     */
    public CR_chirurgie() {
        initComponents();
    ...
    private void rSButtonHover1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonHover1ActionPerformed
        inter_Chirurgie RE = new  inter_Chirurgie();
        ...
        Chirurgie R;
        R = new Chirurgie(s1,s3,s2, s5);
        RE.insertChirurgie(R);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CR_chirurgie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CR_chirurgie().setVisible(true);
            }
        });
    }
