 ...
 * @author pc
 */
public class imageradio extends javax.swing.JFrame {

    /**
     * Creates new form imageradio
     */
    public imageradio() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(757, 624));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(imageradio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new imageradio().setVisible(true);
            }
        });
    }
