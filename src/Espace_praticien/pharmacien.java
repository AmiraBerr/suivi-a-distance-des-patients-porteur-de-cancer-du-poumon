...
import Dossier_Médical.CR_pharmacien;
 ...
 * @author berich
 */
public class pharmacien extends javax.swing.JFrame {
...
String rqt= "select  N_doss_med as 'N° dossier médical', patient_nom  as 'Nom',  patient_prenom as 'Prenom' ,patient_email as 'email' from patient where  (N_doss_med LIKE'" + rech + "' )";
     ...
     public void Remplir_CR( CR_pharmacien C){
       praticien_login ph =new praticien_login();
       String idft= ph.recuperer();
       //nom Docteur
      ...
      // Afficher la table copmtes rendus pharmacien  par date 
       ...
       public void Affichertable_CRS_PHARM() {
        try {
            ...
            String rqt = "select idd as 'id',date as 'Date'from donneespharmacologique  where `idpra` = '"+idft+"' "; 
           ps = cnx.prepareStatement(rqt);
           rs = ps.executeQuery();
    ...
    jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/plateforme_cancer_du_poumon/images/pharmacy.png"))); // NOI18N
    jPanel2.add(jLabel2);
    jLabel2.setBounds(0, -2, 140, 140);
    ...
    jScrollPane11.setViewportView(table_pharm);
        ...
        .addGroup(panelLayout.createSequentialGroup()
            .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                ...
                .addGroup(panelLayout.createSequentialGroup()
                    .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(panelLayout.createSequentialGroup()
                            .addComponent(jDateChooser5, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
                        .addGroup(panelLayout.createSequentialGroup()
    ...
    jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/plateforme_cancer_du_poumon/images/wp1931610.jpg"))); // NOI18N
    profil_praticien.add(jLabel6);
    jLabel6.setBounds(-80, 0, 1270, 670);
    ...
    messagerieLayout.setHorizontalGroup(
        ...
        .addGroup(messagerieLayout.createSequentialGroup()
            ...
            .addGroup(messagerieLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(messagerieLayout.createSequentialGroup()
                    .addComponent(rSButtonHover5, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(18, 18, 18)
                    .addComponent(rSButtonHover6, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addComponent(scrol))
            .addContainerGap())
    );
    ...
    layout.setHorizontalGroup(
        ...
        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
            .addComponent(jPanel2, javax.swing.GroupLayout.DEFAULT_SIZE, 1630, Short.MAX_VALUE)
            .addContainerGap())
    );
    ...
    private void rSButtonHover1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonHover1ActionPerformed
        ...
        CR_pharmacien CR= new CR_pharmacien();
        CR.setVisible(true);
        Remplir_CR(CR);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pharmacien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pharmacien().setVisible(true);
            }
        });
    }
