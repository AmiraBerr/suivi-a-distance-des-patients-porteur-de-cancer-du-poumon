 ...
 * @author berich
 */
public class pneumologue extends javax.swing.JFrame {
 ...
 //------------------------------------------------------------------------------------------------------------------------------------------      
       ...
       //Afficher la table infos suivi 
        ...
        try {
            ...
            String rqt = "select date_saisie as 'Date de saisie',Num_doss_med as 'N° dossier médical' from infos_suivi  where pneumologue_ref LIKE '"+idft+"' "; 
   ...
   //recherche fiche_infos_suivi
        ...
        public void recherche_fiche_infos_suivi( String rech)
     {
         ...
         try {
String rqt= "select date_saisie as 'Date de saisie',Num_doss_med as 'N° dossier médical' from  infos_suivi where  pneumologue_ref LIKE '"+idft+"' AND ( date_saisie LIKE'" + rech + "%' OR  Num_doss_med  LIKE'" + rech+ "%'  )";
            ps = cnx.prepareStatement(rqt);
  ...
  //Afficher table patient
        ...
        try {
          ...
          String rqt = "select  N_doss_med as 'N° dossier médical', patient_nom  as 'Nom',  patient_prenom as 'Prenom' ,patient_date_naiss as 'Date de naissance' from patient where pneumolgue_ref =  '"+idft+"' ";
           ps = cnx.prepareStatement(rqt);
           rs = ps.executeQuery();
     ...
     {
         try {
         String rqt= "select  N_doss_med as 'N° dossier médical', patient_nom  as 'Nom',  patient_prenom as 'Prenom' ,patient_date_naiss as 'Date de naissance' from patient where `pneumolgue_ref` = '"+idft+"' AND (N_doss_med LIKE'" + rech + "%' OR patient_nom LIKE'" + rech+ "%' OR "
      ...
      public void Affichertable_patient() {
        ...
        try {
          ...
          String rqt = "select  N_doss_med as 'N° dossier médical', patient_nom as 'Nom',  patient_prenom as 'Prenom' from patient where pneumolgue_ref =  '"+idft+"' ";
           ps = cnx.prepareStatement(rqt);
           rs = ps.executeQuery();
   ...
   // remplir le champs num de dossier médical à partir de la table :
     ...
     {
         try {
String rqt= "select  N_doss_med as 'N° dossier médical', patient_nom as 'Nom',  patient_prenom as 'Prenom'   from  patient where `pneumolgue_ref` = '"+idft+"' AND (N_doss_med LIKE'" + rech + "%' OR patient_nom LIKE'" + rech+ "%' OR "
                    + "	patient_prenom LIKE'" + rech + "%' )";
            ps = cnx.prepareStatement(rqt);
            rs = ps.executeQuery();
           table_patient.setModel(DbUtils.resultSetToTableModel(rs));
...
String rqt= "select  praticien_nom as 'Nom', praticien_prenom as 'Prenom', praticien_specialite as 'Spécialité' , praticien_email as 'Email' from  praticien where ( praticien_prenom LIKE'" + rech + "%' OR  praticien_nom LIKE'" + rech+ "%' OR "
     ...
     //Afficher table patient
        ...
        try {
          ...
          String rqt = "select  N_doss_med as 'N° dossier médical', patient_nom  as 'Nom',  patient_prenom as 'Prenom' ,patient_email as 'email' from patient where `pneumolgue_ref` =  '"+idft+"' ";
           ps = cnx.prepareStatement(rqt);
           rs = ps.executeQuery();
     ...
     {
         try {
String rqt= "select  N_doss_med as 'N° dossier médical', patient_nom  as 'Nom',  patient_prenom as 'Prenom' ,patient_email as 'email' from patient where `pneumolgue_ref` = '"+idft+"' AND (N_doss_med LIKE'" + rech + "%' OR patient_nom LIKE'" + rech+ "%' OR "
                    + "	patient_prenom LIKE'" + rech + "%' )";
            ps = cnx.prepareStatement(rqt);
            rs = ps.executeQuery();
    ...
    jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Liste des patients", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(3, 182, 215))); // NOI18N
    ...
    jScrollPane4.setViewportView(table_patient);
    ...
    jLabel32.setIcon(new javax.swing.ImageIcon(getClass().getResource("/plateforme_cancer_du_poumon/images/icons8_Search_Property_40px_1.png"))); // NOI18N
    ...
    liste_patientsLayout.setVerticalGroup(
        ...
        .addGroup(liste_patientsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel8, javax.swing.GroupLayout.PREFERRED_SIZE, 367, Short.MAX_VALUE))
    );
    ...
    btn_dossier.setText("Dossier Médicaux");
        ...
        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelpLayout.createSequentialGroup()
            .addGroup(panelpLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                ...
                .addGroup(panelpLayout.createSequentialGroup()
                    .addContainerGap()
                    .addGroup(panelpLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(btn_etat, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jSeparator2, javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(jSeparator1, javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(jSeparator3, javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(btn_profil, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(btn_dossier, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    jLabel17.setText("Service de pneumologie");
    ...
    jPanel1Layout.setHorizontalGroup(
        ...
        .addGroup(jPanel1Layout.createSequentialGroup()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addComponent(nom_prat, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(nom_prat, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                            .addComponent(jLabel3)
                            .addGap(7, 7, 7))))
                .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    C_dossier_med.add(jLabel6);
    jLabel6.setBounds(0, 0, 1120, 620);
    ...
    RDVLayout.setVerticalGroup(
        ...
        .addGroup(RDVLayout.createSequentialGroup()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addComponent(ScrolPane, javax.swing.GroupLayout.DEFAULT_SIZE, 464, Short.MAX_VALUE)
            .addContainerGap())
    );
    ...
    jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/plateforme_cancer_du_poumon/images/bgdoc.jpg"))); // NOI18N
    profil_praticien.add(jLabel8);
    jLabel8.setBounds(0, 0, 1170, 660);
    ...
    jLabel36.setIcon(new javax.swing.ImageIcon(getClass().getResource("/plateforme_cancer_du_poumon/images/icons8_Refresh_48px.png"))); // NOI18N
    jLabel36.setToolTipText("Actualiser");
    ...
    jLabel37.setText("Informations de suivi :");
    ...
    jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/plateforme_cancer_du_poumon/images/bgdoc.jpg"))); // NOI18N
    etat_patient.add(jLabel9);
    jLabel9.setBounds(0, 0, 1180, 670);
    ...
    PanelSlider.setBounds(420, 140, 940, 560);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pneumologue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pneumologue().setVisible(true);
            }
        });
    }
