...
import Dossier_Médical.CR_pathologiste;
 ...
 * @author berich
 */
public class s_anatomie_pathologique extends javax.swing.JFrame {

    String atachement_path;
    String ds;
    public s_anatomie_pathologique() {
        initComponents();
 ...
 public void Afficher(){
     ...
     public void Remplir_CR( CR_pathologiste C){
       praticien_login ph =new praticien_login();
       String idft= ph.recuperer();
       //nom Docteur
    ...
    // Afficher la table copmtes rendus pathologisye par date 
       ...
       public void Affichertable_CRS_ANAP() {
        try {
            ...
            String rqt = "select idap as 'id',date as 'Date'from anatomiepathologique where where `idpra` = '"+idft+"' "; 
           ps = cnx.prepareStatement(rqt);
           rs = ps.executeQuery();
    ...
    table_patient1.setModel(new javax.swing.table.DefaultTableModel(
        ...
        new String [] {
            "N° dossier médical", "Nom", "Prenom", "Email"
        }
    ));
    ...
    panelpLayout.setHorizontalGroup(
        ...
        .addGroup(panelpLayout.createSequentialGroup()
            ...
            .addGroup(panelpLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addComponent(btn_profil, javax.swing.GroupLayout.DEFAULT_SIZE, 366, Short.MAX_VALUE)
    ...
    jPanel2.add(panelp);
    panelp.setBounds(10, 140, 390, 550);
    ...
    jLabel7.setText("Service Anatomie Pathologique");
    ...
    jPanel2.add(jPanel1);
    jPanel1.setBounds(100, 30, 1280, 80);
    ...
    jScrollPane11.setViewportView(table_anap);
    ...
    jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/plateforme_cancer_du_poumon/images/centre-biologique-republique.jpg"))); // NOI18N
    profil_praticien.add(jLabel6);
    jLabel6.setBounds(-400, 0, 1370, 550);
    ...
    PanelSlider.setBounds(420, 140, 970, 550);

    jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/plateforme_cancer_du_poumon/images/ana_pathologique.png"))); // NOI18N
    jPanel2.add(jLabel2);
    jLabel2.setBounds(0, 0, 150, 140);
    ...
    private void rSButtonHover1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonHover1ActionPerformed
        ...
        CR_pathologiste CR= new CR_pathologiste();
        CR.setVisible(true);
        Remplir_CR(CR);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(s_anatomie_pathologique.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new s_anatomie_pathologique().setVisible(true);
            }
        });
    }
